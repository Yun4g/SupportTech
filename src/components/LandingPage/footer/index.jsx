...
function Footer() {
    return(
         <section className=" bg-footerColor text-center h-[75vh] lg:h-[60vh] flex justify-between flex-col p-3 md:p-0">
          ...
          <input type="email" className=' w-96 h-12 md:h-14 rounded-md ps-4 outline-none ' placeholder='Enter Your email' name="email" id="" />
